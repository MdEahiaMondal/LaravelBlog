...
@section('mainContent')
    ...
    <div class="slider header-bg display-table center-text">
        <h1 class="title display-table-cell"><b> {{ $posts->count() }} Result by  <strong style="font-weight: bold; color: #eb6928">{{ $query }}</strong> </b></h1>
    </div><!-- slider -->
    ...
    <section class="blog-area section">
        <div class="container">
            ...
            <div class="row">
                ...
                @else
                    <div class="col-sm-12">
                        <p class="text-center">There is no post on by {{ $query }}</p>
                    </div>
                @endif
